...
function oo0O0(mw) {
    ...
    console.log(atob(b)[J('0x0', ']dQW')](J('0x1', 'GTu!'), '\x27' + mw + '\x27'))
    eval(atob(b)[J('0x0', ']dQW')](J('0x1', 'GTu!'), '\x27' + mw + '\x27'));
    return window.f
}
"""
import execjs
...
result = ctx.call("oo0O0", dt)
print(result)
cookies = {
    'sessionid': 'g1w3mhynud3fv48ncl8b90ciml2xuf7t',
    'Hm_lvt_434c501fe98c1a8ec74b813751d4e3e3': '1749526096,1749538037,1749540164',
    'qpfccr': 'true',
    'no-alert3': 'true',
}
...
headers = {
    ...
    # 'cookie': 'sessionid=g1w3mhynud3fv48ncl8b90ciml2xuf7t; Hm_lvt_434c501fe98c1a8ec74b813751d4e3e3=1749526096,1749538037,1749540164; qpfccr=true; no-alert3=true',
}
num_total = 0
num = 0
for i in range(1, 6):
